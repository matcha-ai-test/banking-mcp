/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cbf216e1c1c345743947e2e179a020fe)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	DB: D1Database;
	BASE_URL: "http://127.0.0.1:8787";
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").BankingMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BankingMCP";
	}
